 ...
 *	reset the device.
 *
 *	This function sends a command to trigger a Watchdog reset on the 
 *	Atmega168 microcontroller. A modified bootloader is necessary for 
 *	this to work, otherwise no reset will be performed.
 *	@param wait			wait for the cartridge to become available again
 */
